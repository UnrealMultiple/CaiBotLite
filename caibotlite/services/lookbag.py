...
advanced_combat_techniques_two = Image.open(
    "assets/images/items/Item_5336.png"
).convert("RGBA")
advanced_combat_techniques_two = advanced_combat_techniques_two.resize(
    (70, 70), Resampling.LANCZOS
)
...
sitting_duck_fishing_pole = Image.open("assets/images/items/Item_2296.png").convert(
    "RGBA"
)
sitting_duck_fishing_pole = sitting_duck_fishing_pole.resize(
    (50, 50), Resampling.LANCZOS
)
...
advanced_combat_techniques = Image.open("assets/images/items/Item_4382.png").convert(
    "RGBA"
)
advanced_combat_techniques = advanced_combat_techniques.resize(
    (50, 50), Resampling.LANCZOS
)
...
class LookBag:
    ...
    def init_look_bag(cls):
        ...
        for filename in os.listdir(item_dir):
            if filename.endswith(".png") and filename.startswith("Item"):
                ...
                cls.image_cache[f"item_{item_id}"] = Image.open(
        ...
        for filename in os.listdir(buff_dir):
            if filename.endswith(".png") and filename.startswith("Buff"):
                ...
                cls.image_cache[f"buff_{buff_id}"] = Image.open(
                    os.path.join(buff_dir, filename)
                ).convert("RGBA")
    ...
    @classmethod
    def draw_item(
        cls, bg_img: Image, draw: ImageDraw, x: int, y: int, item_id: int, stack: int
    ):
        try:
            if item_id < 0:
            ...
            item_font = ImageFont.truetype(
                font="assets/fonts/LXGWWenKaiMono-Medium.ttf", size=14
            )
    ...
    def get_bag_png(cls, payload: Dict) -> Image:
        ...
        bg_img = Image.open("assets/images/backgrounds/Background_4.png").convert(
            "RGBA"
        )
        ...
        draw.text(
            (160, 1040), time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), font=ft
        )

        for h in range(5):
            for i in range(10):
                bg_img.paste(
                    back1, (150 + i * back1.width, back1.height * h + 120), mask=a
                )  # 背包
        index = 0
        for h in range(5):
            for i in range(10):
        ...
        for h in range(4):
            for i in range(10):
                bg_img.paste(
                    back2, (740 + i * back2.width, back2.height * h + 120), mask=a2
                )  # 猪猪
        index = 99
        ...
        for h in range(4):
            for i in range(10):
                bg_img.paste(
                    back2, (1330 + i * back2.width, back2.height * h + 120), mask=a
                )  # 保险
        for h in range(4):
            for i in range(10):
                cls.draw_item(
        ...
        for h in range(4):
            for i in range(10):
                bg_img.paste(
                    back2,
                    (1330 + i * back2.width, back2.height * h + 120 + 280),
                    mask=a,
                )  # 熔炉
        for h in range(4):
            for i in range(10):
        ...
        for h in range(4):
            for i in range(10):
                bg_img.paste(
                    back2,
                    (1330 + i * back2.width, back2.height * h + 120 + 280 + 280),
                    mask=a,
                )
        for h in range(4):
            for i in range(10):
        ...
        for h in range(10):
            ...
            bg_img.paste(
                back4, (150 + back3.width, back2.height * h + 120 + 280 + 30), mask=a
            )
            bg_img.paste(
                back5,
                (150 + back3.width + back4.width, back2.height * h + 120 + 280 + 30),
                mask=a,
            )
        index = 59
        ...
        for h in range(10):
            cls.draw_item(
                bg_img,
                draw,
                150 + back3.width + back4.width,
                back2.height * h + 120 + 280 + 30,
                inv[index][0],
                inv[index][1],
            )  # 盔甲饰品
            index += 1
        ...
        for h in range(10):
            ...
            bg_img.paste(
                back4, (350 + back3.width, back2.height * h + 120 + 280 + 30), mask=a
            )
            bg_img.paste(
                back5,
                (350 + back3.width + back4.width, back2.height * h + 120 + 280 + 30),
                mask=a,
            )
        for h in range(10):
            cls.draw_item(
        ...
        for h in range(10):
            ...
            bg_img.paste(
                back4, (550 + back3.width, back2.height * h + 120 + 280 + 30), mask=a
            )
            bg_img.paste(
                back5,
                (550 + back3.width + back4.width, back2.height * h + 120 + 280 + 30),
                mask=a,
            )
        for h in range(10):
            cls.draw_item(
        ...
        for h in range(5):
            ...
            bg_img.paste(
                back1, (750 + back2.width, back2.height * h + 120 + 280 + 30), mask=a
            )
        index = 89
        for h in range(5):
            cls.draw_item(
        ...
        for h in range(4):
            ...
            bg_img.paste(
                back1, (900 + back2.width, back2.height * h + 120 + 280 + 30), mask=a
            )
        index = 50
        for h in range(4):
            cls.draw_item(
        ...
        bg_img.paste(
            back6, (900 + back2.width, back2.height * 4 + 120 + 280 + 30), mask=a
        )
        bg_img.paste(back6, (900, back2.height * 4 + 120 + 280 + 30), mask=a)
        bg_img.paste(
            Trash, (900 + 10, back2.height * 4 + 120 + 280 + 30 + 10), mask=aTrash
        )
        cls.draw_item(
            bg_img,
            draw,
            900 + back2.width,
            back2.height * 4 + 120 + 280 + 30,
            inv[179][0],
            inv[179][1],
        )
        ...
        font1 = ImageFont.truetype(
            font="assets/fonts/LXGWWenKaiMono-Medium.ttf", size=38
        )
        draw.text(
            (915 + 50 + 60 + 50, 120 + 280 + 30), "玩家信息", font=font1, fill=(0, 0, 0)
        )
        font2 = ImageFont.truetype(
            font="assets/fonts/LXGWWenKaiMono-Medium.ttf", size=30
        )

        bg_img.paste(
            life_item, (915 + 50 + 60, 120 + 280 + 30 + 30 + 15), mask=alife_item
        )
        draw.text(
            (915 + 50 + 60 + 50, 120 + 280 + 30 + 30 + 30),
            "生命:" + life,
            font=font2,
            fill=(255, 106, 106),
        )
        ...
        bg_img.paste(
            mana_item, (915 + 50 + 60, 120 + 280 + 30 + 30 + 15 + 40), mask=amana_item
        )
        draw.text(
            (915 + 50 + 60 + 50, 120 + 280 + 30 + 30 + 30 + 40),
            "魔力:" + mana,
            font=font2,
            fill=(30, 144, 255),
        )
        ...
        if quests_completed >= 50:
            bg_img.paste(
                golden_fishing_rod,
                (915 + 50 + 70, 120 + 280 + 30 + 30 + 30 + 40 + 40),
                mask=agolden_fishing_rod,
            )
            draw.text(
                (915 + 50 + 60 + 50, 120 + 280 + 30 + 30 + 30 + 40 + 40),
                f"渔夫任务数:{quests_completed}次",
                font=font2,
                fill=(255, 223, 0),
            )
        else:
            bg_img.paste(
                sitting_duck_fishing_pole,
                (915 + 50 + 70, 120 + 280 + 30 + 30 + 30 + 40 + 30),
        ...
        bg_img.paste(
            ...
            (915 + 50 + 70, 120 + 280 + 30 + 30 + 30 + 40 + 40 + 30),
            mask=aadvanced_combat_techniques,
        )
        if len(enhances) == 0:
            draw.text(
                (915 + 50 + 60 + 50, 120 + 280 + 30 + 30 + 30 + 40 + 40 + 40),
                f"永久增益:无",
                font=font2,
                fill=(112, 128, 144),
            )
        ...
        if len(economic) != 0 and economic["Coins"] != "":
            bg_img.paste(
                advanced_combat_techniques_two,
                (915 + 50 + 50, 250 + 120 + 280 + 20),
                mask=aadvanced_combat_techniques_two,
            )
            draw.text(
                (915 + 50 + 60 + 50, 250 + 120 + 280 + 30),
                "Economic",
                font=font1,
                fill=(138, 43, 226),
            )
            ...
            bg_img.paste(
                defender_medal,
                (915 + 50 + 70, 250 + 120 + 280 + 30 + 30 + 22),
                mask=adefender_medal,
            )
            draw.text(
                (915 + 50 + 60 + 50, 120 + 250 + 280 + 30 + 30 + 30),
                economic["Coins"],
                font=font2,
                fill=(255, 215, 0),
            )
            ...
            if economic["LevelName"] != "":
                bg_img.paste(
                    warrior_emblem,
                    (915 + 50 + 70, 250 + 120 + 280 + 30 + 30 + 22 + 40 * h),
                    mask=awarrior_emblem,
                )
                draw.text(
                    (915 + 50 + 60 + 50, 250 + 120 + 280 + 30 + 30 + 30 + 40 * h),
                    economic["LevelName"],
                    font=font2,
                    fill=(30, 144, 255),
                )
